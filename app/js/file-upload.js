...
// ----------multiplefile-upload---------
$("#multiplefileuploadvideo").fileinput({
  theme: "explorer-fas",
  uploadUrl: "#",
  deleteUrl: "#",
  ...
  dropZoneTitle:
    '<div class="upload-area"><i class="fa fa-upload"></i><p>Upload Video</p><p class="fs-sm">min size 2mb</p> </div>',
  dropZoneClickTitle: "",
...
$("#multiplefileupload").fileinput({
  ...
  overwriteInitial: false,
  dropZoneTitle:
    '<div class="upload-area"><i class="fa fa-upload"></i><p>Upload Image</p><p class="fs-sm">min size 500kb, PNG & JPEG</p> </div>',
  dropZoneClickTitle: "",
  browseOnZoneClick: true,
  showRemove: false,
  showUpload: false,
